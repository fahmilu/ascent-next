      ...
      <Banner title={data.data.title ? data.data.title : 'Our Team'} />
            <section className="md:pt-[72px] md:pb-[140px] pt-[40px] pb-[80px] bg-white teams-section">
                <div className="container">
                    <h2 className="title-section max-w-[720px]" data-aos='fade-down' data-aos-delay='1500'>{data.data.components[0] ? data.data.components[0].data.title : 'We are a team of strategic experts paving your way towards success.'}</h2>
