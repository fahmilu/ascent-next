...
const NewsCard = ({ data }) => {
    return (
        <a href={data.external_url} target="_blank" className="border-t border-[#FF0000] overflow-hidden relative flex flex-row gap-3 pt-6 group">
            ...
            <div className="flex-grow">
                ...
                <div className={`sm:text-[20px] text-[16px] line-clamp-2 mb-[23px] font-medium leading-[141%] group-hover:text-[#FF0000] transition-colors duration-300`}>{data.title}</div>
            </div>
        </a>
    );
}
