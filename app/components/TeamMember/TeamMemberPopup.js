...
const TeamMemberPopup = ({ member, onClose }) => {
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center md:p-4">
            ...
            <div className={`${styles.teamMemberPopup} max-h-screen overflow-y-auto`}>
                <div className="absolute top-5 right-5 z-10 md:-top-10 md:right-0">
                ...
                <div className="flex flex-col md:flex-row">
                    <div className={`relative w-full md:min-w-[382px] md:w-[382px] min-h-[462px] overflow-hidden ${styles.teamMemberPopupImage}`}>
                    ...
                    <div className="w-full flex-grow p-6 md:p-8">
                        <h2 className="text-[32px]/[141%] font-medium mb-2.5">{member.name}</h2>
                        <p className="text-[16px]/[155%] pb-4 border-b border-[#B3B3B3] mb-4">{member.position}</p>
                        {member.description && (
